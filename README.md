...
```sh
docker pull tolak/substrate-development:v0.1.3
```
...
```sh
docker run -it -p 127.0.0.1:9944:9944 -p 127.0.0.1:9988:9988 -p 127.0.0.1:9999:9999 --name substrate tolak/substrate-development:v0.1.3
```
